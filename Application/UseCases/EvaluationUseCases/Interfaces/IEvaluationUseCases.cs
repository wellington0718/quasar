namespace Application.UseCases.EvaluationUseCases.Interfaces
{
    public interface IEvaluationUseCases
    {
        ...
        Task<IEnumerable<QualityRateDTO>> GetGeneralReport(dynamic parameters);
